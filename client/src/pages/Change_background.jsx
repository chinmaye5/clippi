...
export default function Change_background() {
    ...
    const handleProcessImage = async () => {
        ...
        try {
            ...
            const response = await api.post("/image/replace-background", formData, {
            ...
            if (response.data.success) {
                ...
                setErrorMsg(response.data.message || "Failed to replace background image.");
            }
        } catch (error) {
            console.error(error);
            setErrorMsg(
        ...
        <div className="flex flex-col md:flex-row w-full md:h-full font-mono bg-zinc-50 md:overflow-hidden">
            ...
            <div className="w-full md:w-80 lg:w-96 border-b-4 md:border-b-0 md:border-r-4 border-black bg-white p-6 flex flex-col justify-between md:h-full md:overflow-y-auto select-none">
                ...
                <div className="space-y-5">
                    ...
                    <div className="space-y-2">
                        <label className="block text-xs font-black uppercase tracking-wider text-zinc-700">
                            enter what to replace background with
                        </label>
                        ...
                        <div className="flex gap-2">
                            <div className="flex-1">
                                ...
                                <input
                                    type="prompt"
                                    placeholder="enter what to replace background with"
                                    value={prompt}
            ...
            <div ref={resultRef} className="flex-1 flex flex-col items-center justify-center p-6 lg:p-10 min-h-[50vh] md:h-full bg-zinc-50 md:overflow-hidden">
                {imageUrl ? (
                    ...
                    <div className="border-4 border-dashed border-zinc-400 p-10 sm:p-12 text-center max-w-md bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,0.05)]">
                        ...
                        <p className="text-xs text-zinc-500 uppercase leading-relaxed">
                            Upload an image, enter a prompt for what to replace background with, then hit replace-background.
                        </p>
                    </div>
                )}
            </div>
